...
class JeuTest4Utilisateur extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $utilisateurs = [
            [3, 'Denny', 'Plain', 'nY7!&_4dO,P7G', 'dplain2@google.pl', 80, 'personnel', '0727737577', 'ROLE_COMMER', 0, 1],
            [12, 'Gale', 'Fulbrook', 'cX4\VGk@,OESGtk', 'gfulbrookb@behance.net', 80, 'personnel', '0737595866', 'ROLE_COMMER', 0, 1],
            [1, 'Mame', 'Heales', 'kW8>3z*z', 'mheales0@google.com.hk', 80, 'particulier', '0679435690', 'ROLE_CLIENT', 0, 1],
            [2, 'Hastings', 'Wheowall', 'sW1/\C7.R|', 'hwheowall1@webs.com', 80, 'personnel', '0657298690', 'ROLE_GESTION', 0, 1],
            [2, 'Muramasa', 'Kiyo', 'yopnop80', 'yop@nop.com', 50, 'personnel', '0657298690', 'ROLE_GESTION', 20, 1],
            [4, 'Lincoln', 'Glendenning', 'oB7&rV_eq', 'lglendenning3@chronoengine.com', 60, 'professionnel', '0762618553', 'ROLE_CLIENT', 5, 2],
            [6, 'Kasey', 'Cove', 'hello5041', 'kcove5@usda.gov', 80, 'particulier', '0608249058', 'ROLE_CLIENT', 0, 1],
            [8, 'Rivi', 'Bowyer', 'zI9(AW|?.|(', 'rbowyer7@hao123.com', 65, 'professionnel', '0676519897', 'ROLE_CLIENT', 39, 2],
        ];
